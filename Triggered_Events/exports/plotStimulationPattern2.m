function [fig] = plotStimulationPattern2(t,wave,random,fs,units,label,triggerPoint,time,eeg,ttl,usedTriggers,sleepData)
    % Enlarge figure size
    set(0,'Units','pixels') 
    ...
    subplot(2,3,5),plot(freq,abs(ffts));
    set(gca,'Xlim',[0 80]);
    ...
    subplot(2,3,6),plot(freq,abs(ffts));
    set(gca,'Xlim',[0 80]);
    set(gca,'Ylim',[fftyscale(1) fftyscale(2)]);
