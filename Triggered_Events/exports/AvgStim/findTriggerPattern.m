function [waves, randoms, wavestates] = findTriggerPattern(eeg, ttl, fs, msbefore, msafter, triggerPoint, state)
...
wavetimes = zeros(length(sampleends),2);
...
%     wavetimes(i,1:2) = time(samplestarts(i):sampleends(i));
end
