% Output routine for floxed files with every four samples averaged.
...
%      end
     averagedPoints = 4;
     waves = averagePoints(waves,averagedPoints);
     randoms = averagePoints(randoms,averagedPoints);
     ...
     for j = 1:length(waves(:,1))
        ...
        if exportState == 1
            ...
            timeRow = -msbefore/1000:averagedPoints*1/fs:msafter/1000-averagedPoints/fs;
